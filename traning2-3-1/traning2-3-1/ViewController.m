...
- (void)viewDidLoad {
    ...
    if ([self.userData boolForKey:firstAccessKey]) {
        self.firstAccessResponseLabel.text = [[NSBundle mainBundle]localizedStringForKey:@"notFirstAccessString" value:nil table:@"Localizable"];
    } else {
        [self.userData setBool:YES forKey:firstAccessKey];
        [self.userData synchronize];
        self.firstAccessResponseLabel.text = [[NSBundle mainBundle]localizedStringForKey:@"firstAccessString" value:nil table:@"Localizable"];
    }
...
/*
    [self.userData setObject:self.firstTextField.text forKey:firstTextKey];
    [self.userData synchronize];

    if ([self.userData stringForKey:firstTextKey]) {
        self.firstValueLabel.text = [self.userData stringForKey:firstTextKey];
    }
*/
